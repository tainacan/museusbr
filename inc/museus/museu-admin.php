...
class MUSEUSBR_Museu_Admin_Page {
    ...
    function museusbr_get_registro_card( $post ) {
        ...
        <div class="card">
            ...
            <div class="card-content content">
            <?php echo get_theme_mod('museusbr_registro_descricao_texto', 'O Registro de Museus visa estimular a formalização dos museus, acompanhando suas dinâmicas de criação, fusão, extinção, incorporação e cisão. É obrigatório para todos os museus do Brasil, conforme o Estatuto de Museus e a legislação vigente. Por meio dele, os museus podem aderir ao Sistema Brasileiro de Museus (SBM) e fortalecem a Política Nacional de Museus'); ?>
            </div>
                            ...
                            switch ($registro_status) {
                                ...
                                case 'publish':
                                    ...
                                    if ( MUSEUSBR_ENABLE_CERTIFICADO_REGISTRO ) {
                                        ...
                                        if ( $certificado_registro ) {
                                            echo '<a class="card-links-button" style="white-space: wrap" download="' . add_query_arg('file_id', $certificado_registro, get_stylesheet_directory_uri() . '/inc/registro/registro-serve-file.php') . '" href="' . add_query_arg('file_id', $certificado_registro, get_stylesheet_directory_uri() . '/inc/registro/registro-serve-file.php') . '">';
                                ...
                                case 'trash':
                                    ...
                                    if ( $justificativa_rejeite_arquivo ) {
                                        echo '<a class="card-links-button" style="white-space: wrap" download="' . add_query_arg('file_id', $justificativa_rejeite_arquivo, get_stylesheet_directory_uri() . '/inc/registro/registro-serve-file.php') . '" href="' . add_query_arg('file_id', $justificativa_rejeite_arquivo, get_stylesheet_directory_uri() . '/inc/registro/registro-serve-file.php') . '">';
        ...
        <div class="card">
            ...
            <div class="columns">
                <div class="column is-4">
                    <div class="card-content content">
                    <?php echo get_theme_mod('museusbr_fva_descricao_texto', 'O Formulário de Visitação Anual (FVA) é o instrumento pelo qual os museus devem informar ao Ibram sua visitação anual. Ele gera dados essenciais para a criação de indicadores, planejamento e formulação de políticas públicas, contribuindo para o desenvolvimento do setor museológico no Brasil.'); ?>
                    </div>
