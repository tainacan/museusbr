if (wp && wp.hooks) {
    function tainacanItemEditionItemLoaded (collection, item) {
        ...
        if ( collection.id == museusbr_theme.museus_collection_id) {
            tainacan_plugin.i18n.label_ready_to_create_item = 'Pronto para registrar este museu?';
            ...
            tainacan_plugin.i18n.title_create_item_collection = 'Registrar museu';
            tainacan_plugin.i18n.title_edit_item = 'Editar museu';
            tainacan_plugin.i18n.info_item_draft = 'Este museu está em rascunho e será visível apenas pelos editores com as permissões necessárias. Não é realizada nenhuma validação de campus obrigatórios neste estado.';
